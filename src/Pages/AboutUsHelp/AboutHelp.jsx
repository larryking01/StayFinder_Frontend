...
const AboutHelp = () => {
  ...
  return (
    <div className="about-us">
      ...
      <section>
        <Row className="about-us__mission">
          <h3 className="about-us__mission-text">
      ...
      <section>
        <Row md={2} xs={1} sm={1} className="about-us__row">
          <Col>
            <h3 className="about-us__subheading">Travel your way</h3>
          </Col>
        ...
        <Row md={2} xs={1} sm={1} className="about-us__row">
          <Col>
            <h3 className="about-us__subheading mb-3">
        ...
        <Row md={2} xs={1} sm={1} className="about-us__row">
          <Col>
            ...
            <img
              src={upcycling}
              alt="Sustainable travel illustration"
              className="about-us__icon"
            />
          </Col>
        ...
        <section className="about-us__team">
          <h3 className="about-us__team-heading">Our Team</h3>
        </section>
        ...
        {teams_array.map((team_member, index) => (
          <Row
            ...
            xs={1}
            sm={1}
            className="about-us__row about-us__row--team"
            key={index}
          >
            <Col>
              <img
            ...
            <Col>
              <h3 className="about-us__team-name">
                {team_member.name}
              </h3>

              <h5 className="about-us__team-position">
